...
const SERVICES = [
  ...
  { id: 48, cat: "Информация по заработной плате", icon: "🏥", title: "Удержание взносов на ОСМС с работников",           sla: "Справочно",   desc: "Информация о порядке удержания взносов на обязательное социальное медицинское страхование.", who: "Любой сотрудник", docs: "Не требуются", group: "Информационные материалы" },
  { id: 49, cat: "Информация по заработной плате", icon: "📅", title: "Календарь 2026 года",                              sla: "Справочно",   desc: "Производственный календарь на 2026 год с рабочими и праздничными днями.", who: "Любой сотрудник", docs: "Не требуются", group: "Информационные материалы" },
  { id: 50, cat: "Информация по заработной плате", icon: "🎁", title: "Соцблага",                                         sla: "Справочно",   desc: "Информация о социальных благах и льготах для сотрудников.", who: "Любой сотрудник", docs: "Не требуются", group: "Информационные материалы" },
  { id: 51, cat: "Информация по заработной плате", icon: "🤱", title: "Расчет доплаты к пособию по беременности и родам", sla: "Справочно",   desc: "Порядок и формула расчёта доплаты к пособию по беременности и родам.", who: "Любой сотрудник", docs: "Не требуются", group: "Информационные материалы" },
  { id: 52, cat: "Информация по заработной плате", icon: "🔄", title: "Расчет зарплаты по сменному графику",              sla: "Справочно",   desc: "Методика расчёта заработной платы при сменном графике работы.", who: "Любой сотрудник", docs: "Не требуются", group: "Информационные материалы" },
  { id: 53, cat: "Информация по заработной плате", icon: "🏖", title: "Расчет отпускных",                                 sla: "Справочно",   desc: "Порядок расчёта отпускных выплат.", who: "Любой сотрудник", docs: "Не требуются", group: "Информационные материалы" },
  { id: 54, cat: "Информация по заработной плате", icon: "🏥", title: "Расчет пособия по больничному листку",             sla: "Справочно",   desc: "Порядок расчёта пособия по временной нетрудоспособности.", who: "Любой сотрудник", docs: "Не требуются", group: "Информационные материалы" },
  { id: 55, cat: "Информация по заработной плате", icon: "💰", title: "Расчет зарплаты от стандартного оклада",           sla: "Справочно",   desc: "Методика расчёта заработной платы на основе стандартного оклада.", who: "Любой сотрудник", docs: "Не требуются", group: "Информационные материалы" },
              ...
              const ServiceCard = ({ s }) => (
                <div style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <Btn small onClick={() => { if(s.isOnboarding){ navigate("onboarding"); } else if(s.link){ window.open(s.link, "_blank"); } else { setSelected(s); setPage("form"); } }}>
