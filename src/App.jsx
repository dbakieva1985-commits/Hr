...
const SERVICES = [
  ...
  // ── Кадровый резерв ───────────────────────────────────────────────────────
  // ── Вакансии Банка ────────────────────────────────────────────────────────
  { id: 72, cat: "Вакансии Банка", icon: "👔", title: "Старший менеджер",                                                              sla: "Актуально", desc: "Место работы: г. Алматы.",                                  who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },
  { id: 73, cat: "Вакансии Банка", icon: "📊", title: "Старший менеджер в управление учёта казначейских операций",                    sla: "Актуально", desc: "Место работы: г. Алматы.",                                  who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },
  { id: 74, cat: "Вакансии Банка", icon: "📈", title: "Аналитик данных",                                                               sla: "Актуально", desc: "Место работы: г. Алматы.",                                  who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },
  { id: 75, cat: "Вакансии Банка", icon: "⭐", title: "Старший менеджер Управления качества сервиса",                                 sla: "Актуально", desc: "Место работы: г. Алматы.",                                  who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },
  { id: 76, cat: "Вакансии Банка", icon: "👤", title: "Менеджер (временная)",                                                          sla: "Актуально", desc: "Временная позиция. Место работы: г. Алматы.",             who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },
  { id: 77, cat: "Вакансии Банка", icon: "🏦", title: "Главный менеджер (временная позиция) в управление учёта казначейских операций", sla: "Актуально", desc: "Временная позиция. Место работы: г. Алматы.",             who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },
  { id: 78, cat: "Вакансии Банка", icon: "💳", title: "Кассир г. Байконур",                                                            sla: "Актуально", desc: "Место работы: г. Байконур / Кызылорда.",                  who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },
  { id: 79, cat: "Вакансии Банка", icon: "🔒", title: "Middle SOC Analyst",                                                             sla: "Актуально", desc: "Место работы: г. Алматы. IT-безопасность.",              who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },
  { id: 80, cat: "Вакансии Банка", icon: "💻", title: "Старший разработчик",                                                           sla: "Актуально", desc: "Место работы: г. Алматы.",                                  who: "Все сотрудники", docs: "Не требуются", btnText: "Узнать больше", link: "https://myhalyk.kz" },

  // ── Реферальная программа ─────────────────────────────────────────────────
  { id: 81, cat: "Реферальная программа", icon: "🌟", title: "HR4U — Реферальная программа Halyk",
    sla: "Справочно",
  ...
  { id: 82, cat: "Реферальная программа", icon: "📝", title: "Подать заявку по реферальной программе",
    sla: "5 раб. дней",
