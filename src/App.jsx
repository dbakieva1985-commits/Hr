...
const SERVICES = [
  ...
  // ── Кафетерий льгот ───────────────────────────────────────────────────────
  { id: 90,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🏠", title: "Субсидирование ипотеки",
    sla: "5 раб. дней",
    ...
    who: "Любой сотрудник", docs: "Документы по ипотечному договору" },

  { id: 91,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🏥", title: "Медицинское страхование",
    sla: "3 раб. дня",
    desc: "Изучите документы, выберите ассистанс‑компанию и программу страхования, при желании прикрепите членов семьи. Заполните заявление, подпишите и передайте работнику ДУП.\n\nПериод действия: 11.07.2026 – 10.07.2027\nАссистансы: ТОО «Медикер»; ТОО АК «Меди-сервис»\nПрограммы: Standard, Classic, Elite, VIP\nОплата: долевое участие Банк / работник",
    who: "Любой сотрудник", docs: "Программы страхования; Список исключений; Список ЛПУ; Алгоритм обращения; Заявление", btnText: "Подать заявление" },

  { id: 92,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🛡️", title: "Страхование жизни",
    sla: "3 раб. дня",
    desc: "Ознакомьтесь с условиями, заполните заявление выгодоприобретателя и передайте в ДУП.\n\nУсловия выплат:\n• В случае смерти — 100% страховой суммы\n• Инвалидность I группы — 50% страховой суммы\n• Инвалидность II группы — 25% страховой суммы",
    who: "Любой сотрудник", docs: "Заявление выгодоприобретателя", btnText: "Заявление выгодоприобретателя" },

  { id: 93,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🎖️", title: "Выслуга лет",
    sla: "Справочно",
    desc: "Сотрудник получает грамоту и премию за работу в Группе Халык.\n\n• Стаж 15 лет — 50% от оклада\n• Стаж 20 и 25 лет — 75% от оклада\n• Стаж 30 лет и более (кратно 5) — 100% от оклада",
    who: "Любой сотрудник", docs: "Не требуются", noBtn: true },

  { id: 94,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "💝", title: "Льготы при личных событиях",
    sla: "3 раб. дня",
    desc: "Подайте заявку на материальную помощь и прикрепите документы, подтверждающие событие. ДУП согласует выплату.\n\n• В связи со смертью близких (супруг/а, родители, дети) — 40 МРП\n• Выход на пенсию — по условиям программы",
    who: "Любой сотрудник", docs: "Документы, подтверждающие событие" },

  { id: 95,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🧠", title: "Психологическая помощь",
    sla: "2 раб. дня",
    desc: "Подайте заявку на консультацию. В ответном сообщении вы получите промокод — перейдите на сайт психологов и запишитесь на сессию.",
    who: "Любой сотрудник", docs: "Не требуются" },

  { id: 96,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "💎", title: "Бонусные программы / Halyk Club",
    sla: "Справочно",
    desc: "Перейдите на интрасайт в раздел Halyk Club и ознакомьтесь с актуальными партнёрскими скидками и привилегиями для сотрудников.",
    who: "Любой сотрудник", docs: "Не требуются", noBtn: true, link: "http://intranet/halyk-club", btnText: "Открыть Halyk Club" },

  { id: 98,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "💪", title: "Программы оздоровления",
    sla: "3 раб. дня",
    desc: "Участвуйте в спортивных турнирах, спартакиадах и тренировках. Подайте заявку на интересующее мероприятие.\n\n1. Турниры и спартакиады — заявка на участие\n2. Спортивные сообщества — присоединиться к команде\n3. Тренировки — запись на корпоративные тренировки",
    who: "Любой сотрудник", docs: "Не требуются" },

  { id: 99,  cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🎓", title: "Компенсация расходов на образование",
    sla: "Справочно",
    desc: "Справочная информация об условиях компенсации затрат на внешнее обучение, MBA и профессиональное развитие.",
    who: "Любой сотрудник", docs: "Не требуются", noBtn: true },

  { id: 100, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🎉", title: "Социальные мероприятия и корпоративные выезды",
    sla: "3 раб. дня",
    desc: "Следите за рассылками и подавайте заявку на участие в корпоративных мероприятиях.\n\n1. Благотворительные мероприятия\n2. Корпоративные выезды и тимбилдинги",
    who: "Любой сотрудник", docs: "Не требуются" },

  { id: 101, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🌴", title: "Дополнительный оплачиваемый отпуск",
    sla: "3 раб. дня",
    desc: "Дополнительные оплачиваемые дни предоставляются по заявлению:\n\n1. При вступлении в брак — 3 р.д. (не позднее 3 месяцев)\n2. Смерть супруга/родителей/детей/братьев/сестёр — 3 р.д. (не позднее 3 месяцев)\n3. Рождение ребёнка (для отца) — 1 р.д. (не позднее 2 месяцев)\n4. Скрининговое исследование / постановка на медучёт — по заявлению\n5. Беременность до 12 недель — до 3 р.д.",
    who: "Любой сотрудник", docs: "Подтверждающие документы" },

  { id: 102, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🪑", title: "Программы по улучшению условий труда",
    sla: "Справочно",
    desc: "Ознакомьтесь с расположением уголков для досуга в офисах Банка: теннисные столы, настольный футбол, массажные кресла.",
    who: "Любой сотрудник", docs: "Не требуются", noBtn: true, link: "http://intranet/office-comfort", btnText: "Открыть карту офисов" },

  { id: 104, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🌿", title: "Эко-программы и устойчивое развитие",
    sla: "3 раб. дня",
    desc: "Направьте заявку на участие в экологических акциях: субботники, эко-инициативы, уборка офиса, лекции, донорство.",
    who: "Любой сотрудник", docs: "Не требуются" },

  { id: 105, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "✈️", title: "Поддержка при ротации",
    sla: "5 раб. дней",
    desc: "Ознакомьтесь с условиями компенсации расходов при приёме или переводе работника внутри Группы «Халык», связанном с переездом в другую местность.",
    who: "Любой сотрудник", docs: "Документы о переводе / переезде" },

  { id: 108, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "👴", title: "Поддержка при выходе на пенсию",
    sla: "5 раб. дней",
    desc: "Ознакомьтесь с условиями выхода на пенсию: полагающиеся выплаты, срок отработки и другие условия программы.",
    who: "Любой сотрудник", docs: "Не требуются" },

  { id: 109, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🎯", title: "Клубы по интересам и профессиональные сообщества",
    sla: "3 раб. дня",
    desc: "Вступайте в сообщества по интересам: книги, горы, спорт (бег, футбол, баскетбол, волейбол, настольный и большой теннис, шахматы), английский язык, благотворительность, эко-активисты.",
    who: "Любой сотрудник", docs: "Не требуются" },

  { id: 110, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🅿️", title: "Предоставление парковочных мест",
    sla: "3 раб. дня", tag: "рук",
    desc: "Всем руководителям предоставляются парковочные места. ДУП выделяет места для главных менеджеров по квоте. Директор распределяет места внутри подразделения. Внесите данные: техпаспорт, права, данные автомобиля — процесс автоматизирован.",
    who: "Руководитель / Главный менеджер", docs: "Техпаспорт, водительское удостоверение" },

  { id: 111, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "🤱", title: "Выплаты по беременности и родам",
    sla: "5 раб. дней",
    desc: "Компенсация за потерю дохода в связи с беременностью и родами. Предоставляется на основании листка временной нетрудоспособности, по установленным условиям.",
    who: "Любой сотрудник", docs: "Листок временной нетрудоспособности" },

  { id: 112, cat: "Compensation & Benefits", group: "Кафетерий льгот", icon: "📱", title: "Компенсация мобильной связи",
    sla: "3 раб. дня", tag: "рук",
    desc: "Работнику предоставляется право на подключение к корпоративной сети мобильной связи по определённым условиям для руководителей.",
    who: "Руководитель", docs: "Не требуются" },
