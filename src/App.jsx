...
const SERVICES = [
  ...
  { id: 45, cat: "Информация по заработной плате", icon: "📄", title: "Справка для сдачи налоговой декларации",           sla: "1 раб. день", desc: "Справка о доходах для предоставления в налоговые органы.", who: "Любой сотрудник", docs: "Не требуются", btnText: "Получить справку" },
  { id: 46, cat: "Информация по заработной плате", icon: "💵", title: "Расчет заработной платы 2026",                     sla: "Справочно",   desc: "Информация о порядке расчёта заработной платы в 2026 году.", who: "Любой сотрудник", docs: "Не требуются", btnText: "Проверить расчет" },
