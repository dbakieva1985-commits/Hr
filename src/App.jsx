...
const SERVICES = [
  ...
  { id: 46, cat: "Информация по заработной плате", icon: "💵", title: "Расчет заработной платы 2026",                     sla: "Справочно",   desc: "Информация о порядке расчёта заработной платы в 2026 году.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 47, cat: "Информация по заработной плате", icon: "📉", title: "Налоговые вычеты 2026",                            sla: "Справочно",   desc: "Справочная информация по налоговым вычетам на 2026 год.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 48, cat: "Информация по заработной плате", icon: "🏥", title: "Удержание взносов на ОСМС с работников",           sla: "Справочно",   desc: "Информация о порядке удержания взносов на обязательное социальное медицинское страхование.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 49, cat: "Информация по заработной плате", icon: "📅", title: "Календарь 2026 года",                              sla: "Справочно",   desc: "Производственный календарь на 2026 год с рабочими и праздничными днями.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 50, cat: "Информация по заработной плате", icon: "🎁", title: "Соцблага",                                         sla: "Справочно",   desc: "Информация о социальных благах и льготах для сотрудников.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 51, cat: "Информация по заработной плате", icon: "🤱", title: "Расчет доплаты к пособию по беременности и родам", sla: "Справочно",   desc: "Порядок и формула расчёта доплаты к пособию по беременности и родам.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 52, cat: "Информация по заработной плате", icon: "🔄", title: "Расчет зарплаты по сменному графику",              sla: "Справочно",   desc: "Методика расчёта заработной платы при сменном графике работы.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 53, cat: "Информация по заработной плате", icon: "🏖", title: "Расчет отпускных",                                 sla: "Справочно",   desc: "Порядок расчёта отпускных выплат.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 54, cat: "Информация по заработной плате", icon: "🏥", title: "Расчет пособия по больничному листку",             sla: "Справочно",   desc: "Порядок расчёта пособия по временной нетрудоспособности.", who: "Любой сотрудник", docs: "Не требуются" },
  { id: 55, cat: "Информация по заработной плате", icon: "💰", title: "Расчет зарплаты от стандартного оклада",           sla: "Справочно",   desc: "Методика расчёта заработной платы на основе стандартного оклада.", who: "Любой сотрудник", docs: "Не требуются" },
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <Btn small onClick={() => { if(s.isOnboarding){ navigate("onboarding"); } else if(s.link){ window.open(s.link, "_blank"); } else { setSelected(s); setPage("form"); } }}>
                      {s.isOnboarding || s.link ? "Открыть" : "Подать заявку"}
                    </Btn>
                  </div>
                </div>
              );
