...
const SERVICES = [
  ...
  { id: 12, cat: "Кадровое администрирование", icon: "📋", title: "Приказ на выход работы в выходные / праздничные дни",        sla: "2 раб. дня",  desc: "Оформление приказа на работу в выходные и праздничные дни.", who: "Руководитель / HR", docs: "Список сотрудников, даты, обоснование" },
  ...
  { id: 38, cat: "Подбор персонала", icon: "✅", title: "Согласование кандидата",    sla: "2 раб. дня",  desc: "Согласование финального кандидата на вакансию: руководитель → HR → директор.", who: "Руководитель подразделения", docs: "Резюме кандидата, условия оффера", isApproval: true },
