...
const SERVICES = [
  ...
  { id: 89,  cat: "Compensation & Benefits", icon: "🤝", title: "Реферальная программа",                             sla: "Справочно",   desc: "Система вознаграждения за успешные рекомендации новых сотрудников: бонусы и дополнительные льготы.", who: "Любой сотрудник", docs: "Не требуются", noBtn: true },
